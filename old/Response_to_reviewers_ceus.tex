...
%Please reformat your reply to the reviewers according to the journal demands.
%1. Your reply should consist of the comment-reply pairs.
%2. For each review, copy every comment, including positive ones, and reply to each directly and in full. If necessary, you may cite  in your reply textual changes that are made in the manuscript. 
%3. If you disagree with the reviewer's comment, state this clearly in your reply and explain your rebuttal.
%4. Separate between your replies to the comments of the editor (if any) and each of the reviewers. 
%5. Number comments of each reviewer and reply to them in exactly the same order as they are listed in the review.
%6. If different reviewers point to the same flaws, repeat your replies, while mentioning that this is the same comment as already replied. 
%7. Use italics when you cite reviewer's comment and normal font for your reply. 
%You may preserve your general reply to the reviewers' comments, as it is now, while it should be located after the above list of the direct replies in your reply letter. 
