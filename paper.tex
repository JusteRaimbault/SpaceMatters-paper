...
\end{figure} %
%%%%%%%%%%%%%%%%%%%%%%
\comment[FL]{à discuter, rappeler sens des paramètres alpha, beta, etc. ; pourquoi appeler cela des "meta paramètres"? maintenant on appele cela des gamma parametres?}
