...
% Cover Letter
% Dear editors,
%We are pleased with my coauthors to submit an original research article entitled ``Initial spatial conditions in simulation models: the missing leg of sensitivity analyses?'' for consideration for publication in Environment and Planning B. This article deals with the central yet poorly explored issue of the sensitivity of geosimulation models to their spatial context, and more precisely their spatial initial conditions. It does not rely on previously published work. Preliminary results where however presented as an oral parallel session talk at ECTQG 2015, Bari, and at Geocomputation Conference 2017, Leeds. We did not have any previous interaction with EPB regarding this manuscript. This manuscript has not been published and is not under consideration for publication elsewhere. We have no conflicts of interest to disclose. We do not have any opposed reviewer.
% Yours faithfully,
% Juste Raimbault
