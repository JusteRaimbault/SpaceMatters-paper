...
We consider that the method presented in this paper holds great potential for strengthening socio-spatial models' exploration. However, two limits and two areas of opportunities have still not been tackled. 
...
While we investigated the sensitivity to geometry of models together with their indicators, a potential research direction is to study the dependance of indicators themselves to the spatial configuration. % TODO finish
...
This relates to relations between empirical, conceptual and modeling dimensions of quantitative research in social sciences, as coined by \cite{livet2010ontology}. % TODO finish
