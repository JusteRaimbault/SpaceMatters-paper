...
\added{\cite{kuhnert2005comparing} map comparison techniques}

\added{\cite{kruskal1983overview} parallel with time-series comparison techniques (see reviewer comment - however more constrained as two dimensional indexing)}
...
\added{We give in Fig.~\ref{fig:stylized-generator} plots roughly summarizing the behavior of the density grid generator, according to parameters $(\alpha,\beta)$.}

\todo{bla bla on generator scale / real configs in the initial paper}

%%%%%%%%%%%%%%
\begin{figure*}
	\includegraphics[width=0.49\linewidth]{figures/alpha_beta_examples.png}
    \includegraphics[width=0.49\linewidth]{figures/alpha_beta_schemas.png}
    \caption{\added{\textbf{Stylized behavior of the density grid generator.}}\label{fig:stylized-generator}}
\end{figure*}
%%%%%%%%%%%%%%
...
\added{We give below the pseudo-code for the implementations we used of both models.}
