...
For both models we estimate the Sharpe ratios for each indicator by $S(X) = \hat{\Eb{X}}/\hat{\sigma}(X)$ with standard estimators for average and standard deviation. The summary statistics computed on repetitions for all parameter points are given in Table~\ref{tab:summarysharpes}.
...
\begin{table*}
	\caption{\added{\textbf{Summary statistics of different distances for schelling.}}}
...
\begin{table*}
	\caption{\added{\textbf{Summary statistics of different distances for sugarscape.}}}
	\begin{tabular}{|ccccccc|}
    	$q$ & Min. & 1st Qu. & Median & Mean & 3rd Qu. & Max. \\\hline
