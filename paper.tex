...
%In this paper, we offer a methodological solution to the problem of sensitivity of simulation models to initial spatial conditions with two application cases (Schelling and Sugarscape). 
...
%where $\mu_{\vec{\alpha}_i}$ are the phase diagrams at given generator parameters $\vec{\alpha}_i$.
% pour le coup cette précision me semble superflue
\comment[FL]{dire plutôt pourquoi le choix de cette fonction qui n'a rien de trivial : d'où cela sort-il? Quels avantages de cette fonction mathématique? Comment est calculée la Variance?}
...
\begin{figure}[!t]
\centering
	%\includegraphics[width=0.9\textwidth]{figuresraw/GridPresentation.png}
 ...
 \comment[FL]{à discuter, rappeler sens des paramètres alpha, beta, etc. ; pourquoi appeler cela des "meta paramètres"? maintenant on appele cela des gamma parametres?} \comment[JR]{+ correc nombre de chiffres significatifs}
...
\begin{figure}[!t]
\centering
	%\includegraphics[width=0.8\textwidth]{figuresraw/relativedistance_metaparams.png}
...
\begin{figure}[!t]
\centering
	%\includegraphics[width=0.8\textwidth]{figuresraw/relativedistance_morphspace.png}
...
\begin{figure}[!t]
\centering
%\includegraphics[width=0.48\textwidth]{figuresraw/schelling-relativedistance_metaparams_mean.png}
%\includegraphics[width=0.48\textwidth]{figuresraw/schelling-relativedistance_morphspace_mean.png}
