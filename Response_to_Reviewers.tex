...
\begin{itemize}
    ...
    \comment[CC]{à faire dans le papier}
    ...
    \comment[CC]{à ajouter dans le papier}[(JR) fait au début]
...
\begin{itemize}
	...
	\item \comment[JR]{to the best of my knowledge there is no full-world morphological classification of cities (and surely because global 1km density dataset is not robust enough for that - already with the European grid it is not perfect)}
