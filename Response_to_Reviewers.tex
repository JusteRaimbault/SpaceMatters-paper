...
\resizebox{0.9\textwidth}{!}{ 
	\includegraphics{figures/SpaceMatters2.bmp}
} \caption{\textbf{Effects of clustering of forbidden cells on the number of communities emerging from an adapted Schelling model (implementation on Netlogo).}} \label{fig:Fig1}
\end{center}
\end{figure*}
